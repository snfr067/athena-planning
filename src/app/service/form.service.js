...
var FormService = /** @class */ (function () {
     ...
     * @param result
     */
    FormService.prototype.setHstToForm = function (result) {
        // console.log(result);
        var calculateForm = new CalculateForm_1.CalculateForm();
     ...
     * @param result
     */
    FormService.prototype.setHstToBsNumOpt = function (result) {
        var isBsNumOpt = result['isBsNumberOptimization'];
     ...
     * @param result
     */
    FormService.prototype.setHstToUnAch = function (result) {
        var unAchievedObj = {
     ...
     * @param result
     */
    FormService.prototype.setHstToFieldCoverageRatio = function (result) {
        var realRatio = 0;
    ...
    FormService.prototype.setHstToFieldSINRRatio = function (result) {
        var realRatio = [];
    ...
    FormService.prototype.setHstToFieldRSRPRatio = function (result) {
        var realRatio = [];
    ...
    FormService.prototype.setHstToFieldULThroughputRatio = function (result) {
        var realRatio = [];
    ...
    FormService.prototype.setHstToFieldDLThroughputRatio = function (result) {
        var realRatio = [];
        if (result['output'].evaluationResult.field.throughput.ratio != null) {
            for (var i = 0; i < result['output'].evaluationResult.field.throughput.ratio.length; i++) {
    ...
    FormService.prototype.setHstToUECoverageatio = function (result) {
        var realRatio = 0;
    ...
    FormService.prototype.setHstToUEULThroughputRatio = function (result) {
        var realRatio = [];
    ...
    FormService.prototype.setHstToUEDLThroughputRatio = function (result) {
        var realRatio = [];
        if (result['output'].evaluationResult.ue.throughputByRsrp.ratio != null) {
            for (var i = 0; i < result['output'].evaluationResult.ue.throughputByRsrp.ratio.length; i++) {
     ...
     * @param result
     */
    FormService.prototype.setHstOutputToResultOutput = function (result) {
        var output = {};
